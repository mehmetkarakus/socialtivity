...
var turkiyeIlleri = {
  ...
  Burdur: ["Ağlasun", "Altınyayla", "Bucak", "Çavdır", "Çeltikçi", "Gölhisar", "Karamanlı", "Merkez", "Tefenni", "Yeşilova"],
...
// DOMContentLoaded olayına event listener ekleyerek çalışmaları başlat
document.addEventListener("DOMContentLoaded", function () {
  ...
  sehirSelect.addEventListener("change", function () {
    ...
    ilceSelect.innerHTML = ""; // İlçe seçim kutusunu temizle

    if (secilenSehir && turkiyeIlleri[secilenSehir]) {
      turkiyeIlleri[secilenSehir].forEach((district) => {
        const option = document.createElement("option");
      ...
      const option = document.createElement("option");
      option.value = "";
      option.textContent = "Önce şehir seçin";
  ...
  // .nice-select.open .list stilini tanımla
